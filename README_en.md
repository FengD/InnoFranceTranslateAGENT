...
This project now supports SGLang and VLLM OpenAI-compatible interfaces. Use the provider-specific API base variables:
...
Note: When using SGLang or VLLM, make sure you have correctly configured `SGLANG_API_BASE` or `VLLM_API_BASE` to point to the corresponding service address.
